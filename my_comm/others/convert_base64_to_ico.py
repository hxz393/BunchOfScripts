...
def convert_base64_to_ico(base64_string: str) -> Optional[str]:
    ...
    try:
        ...
        raise ValueError(f"输入的字符串无法被Base64解码: {str(e)}")
